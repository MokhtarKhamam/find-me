                    ...
                    {steps.map((label, index) => {
                        ...
                        return (
                            <Step key={label} {...stepProps}>
                                <StepButton
                                    ...
                                    sx={{
                                        '& .MuiStepLabel-root .Mui-completed': {
                                            color: '#C45B00', // circle color (COMPLETED)
                                            fontSize: { sx: "small", md: "xxx-large" },
                                            zIndex: "20"

                                        },
                                        '& .MuiStepLabel-root .Mui-active': {
                                            color: '#C45B00', // circle color (ACTIVE)
                                            fontSize: { sx: "small", md: "xxx-large" },
                                            zIndex: "20"
                                        },
                                ...
                                >
                                    <span style={{ color: "#C45B00" }}>{label}</span>
                                </StepButton>
                            </Step>
                        );
                    })}
            ...
            <Box sx={{ mt: 2, display: 'flex', flexDirection: "column", justifyContent: 'center' }} >
                {done ? (
                    ...
                    <Box sx={{
                        ...
                        <Button
                            sx={{ backgroundColor: '#C45B00', mt: '20px', color: '#fff', '&:hover': { color: 'black' } }}
                            size='large'
                            onClick={handleReset}>Reset</Button>
                    </Box>
                ) : (
                    <div>
                        <Box sx={{ backgroundColor: '#F9E0BF', borderRadius: '5px', width: { sx: "small", md: "900px" }, margin: 'auto' }}>
                            <div style={{ padding: '20px' }}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', my: 2 }}>
                                    ...
                                    <Button
                                        // variant="contained"
                                        size='large'
                                        sx={{ backgroundColor: '#C45B00', color: '#fff', borderRadius: '20px', width: "140px", height: "45px", '&:hover': { color: 'black' } }}
                            ...
                            <Box sx={{ textAlign: 'center', padding: '30px 0', backgroundColor: '#C45B00' }} >
